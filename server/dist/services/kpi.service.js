...
const recalculateUserKPI = async (userId, period) => {
    ...
    await pool.request()
        .input('id', mssql_1.default.VarChar, `k_${userId}_${period}`)
        .input('userId', mssql_1.default.VarChar, userId)
        .input('period', mssql_1.default.VarChar, period)
        .input('assigned', mssql_1.default.Int, totalAssigned)
        .input('completed', mssql_1.default.Int, totalCompleted)
        .input('onTime', mssql_1.default.Int, onTime)
        .input('score', mssql_1.default.Decimal(5, 2), score)
        .query(`
...
exports.recalculateUserKPI = recalculateUserKPI;
